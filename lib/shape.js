 ...
 */
var Shape = function (oParams) {
    oContent = oParams.content;
...
Shape.prototype.text = function (aParagraphs, oOptions) {
    if(!this._oText) this._oText = new Text({ content: this.content["p:txBody"][0], slide: this.slide, presentation: this.presentation });
