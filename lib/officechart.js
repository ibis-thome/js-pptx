  ...
  return {
    ...
    setTextSize: function(textSize) {
      if (textSize !== undefined) {
         ...
         helper.mergeDeep(this.chartSpec['c:chartSpace'], textRef);
      }
    },
    ...
    setTitle: function (title) {
      if (title !== undefined) {
        ...
        helper.mergeDeep(this.chartSpec['c:chartSpace']['c:chart'], titleRef);
      }
    },
    ...
    setValAxisTitle: function (title) {
      if (title) {
        ...
        helper.mergeDeep(this.chartSpec['c:chartSpace']['c:chart']['c:plotArea']['c:valAx'], titleRef);
      }
    },
    ...
    setCatAxisTitle: function (title) {
      if (title) {
        var titleRef = this._title(title);
        helper.mergeDeep(this.chartSpec['c:chartSpace']['c:chart']['c:plotArea']['c:catAx'], titleRef);
      }
    },
    ...
    setValAxisNumFmt: function (format) {
      if (format !== undefined) {
        ...
        helper.mergeDeep(this.chartSpec['c:chartSpace']['c:chart']['c:plotArea']['c:valAx'], numFmtRef)
      }
    },
    ...
    setValAxisScale: function (min, max) {
      if (min!==undefined || max!== undefined) {
        ...
        helper.mergeDeep(this.chartSpec['c:chartSpace']['c:chart']['c:plotArea']['c:valAx'], scalingRef);
      }
    },

    mergeChartXml: function (xml) {
      if (xml !== undefined) {
        helper.mergeDeep(this.chartSpec['c:chartSpace'], xml);
      }
    },
...
///
    ...
    _ser: function (serie, i) {
      ...
      if (serie.xml) {
        serieData['c:ser'] = helper.mergeDeep(serieData['c:ser'], serie.xml)
      }
